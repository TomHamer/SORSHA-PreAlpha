...
class baristaSettingsViewController: UIViewController {
    ...
    @IBAction func serviceValueChanged(sender: AnyObject) {
        if serviceSwitch.on == true {
            ...
            //show all orders and send the push
            //tell the barista that he needs to fill a couple of last orders before he can stop
